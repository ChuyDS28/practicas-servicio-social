      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className=" col s6">
          ...
          >
            ...
            <option value="FISICO_MATEMATICAS" id="1">Fisico Matematicas</option>
            <option value="MEDICO_BIOLOGICAS" id="2">Medico Biologicas</option>
            <option value="SOCIALES_ADMINISTRATIVAS" id="3">
              Sociales y Administrativas
            </option>
            <option value="TICS" id="4">TICS</option>
          </select>
        </div>
        <div className=" col s6">
        ...
        <button className="modal-close waves-effect waves-green btn-flat right" onClick={clear}>
          Cerrar
        </button>
      </form>
    </>
