...
const Table6 = ({ data }) => {
  ...
  <br/>
  <br/>
  <Text style={styles.texto2}>*Respecto al Número de Registro CELEX, éste se les solicita a las Unidades Académicas lo anoten en en Sistema de Educación Permanente (http://aplicaciones.dec.ipn.mx/autoevaluacion
 o http//148.204.110.122/autoevaluacion), es responsabilidad de la Escuela y/o Centro, el obtenerlo y mantenerlo vigente ante la Dirección de Formación de Lenguas Extranjeras.</Text>
   <br/>
   <Firmas/>
    </View>
  );
