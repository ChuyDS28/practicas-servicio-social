...
const Row = (props) => {
  return (
    <View style={styles.tr}>
      {props && (
        <>
          <Text style={[styles.td,{flexBasis:"64px",textAlign:"center"}]}>{props.Nivel}</Text>
          <Text style={[styles.td,{flexBasis:"22px",textAlign:"center"}]}>{props.Mes1}</Text>
          <Text style={[styles.td,{flexBasis:"37px",textAlign:"center"}]}>{props.Mes2}</Text>
          <Text style={[styles.td,{flexBasis:"31px",textAlign:"center"}]}>{props.Mes3}</Text>
          <Text style={[styles.td,{flexBasis:"47px",textAlign:"center"}]}>{props.Mes4}</Text>
          <Text style={[styles.td,{flexBasis:"57px",textAlign:"center"}]}>{props.Mes5}</Text>
          <Text style={[styles.td,{flexBasis:"30px",textAlign:"center"}]}>{props.Acumulado}</Text>
          <Text style={[styles.td,{flexBasis:"30px",textAlign:"center"}]}>{props.Variacion}</Text>
  ...
  return (
    <View >
      ...
      <View style={styles.table}>
        ...
        <Row Nivel="CENTROS DE INVESTIGACIÓN" Mes1="11" Mes2="0" Mes3="0" Mes4="1" Mes5="" Acumulado="0" Variacion="-100.00%"/>
         <Row Nivel="CENTROS DE INVESTIGACIÓN" Mes1="11" Mes2="0" Mes3="0" Mes4="1" Mes5="" Acumulado="0" Variacion="-100.00%"/>
         <Row Nivel="CENTROS DE INVESTIGACIÓN" Mes1="11" Mes2="0" Mes3="0" Mes4="1" Mes5="" Acumulado="0" Variacion="-100.00%"/>
         <Row Nivel="CENTROS DE INVESTIGACIÓN" Mes1="11" Mes2="0" Mes3="0" Mes4="1" Mes5="" Acumulado="0" Variacion="-100.00%"/>
        <View style={styles.barra}>
         <Row Nivel="TOTAL" Mes1="11" Mes2="0" Mes3="0" Mes4="1" Mes5="" Acumulado="0" Variacion="-100.00%"/>
         <Text style={[styles.td,{backgroundColor:"#cdcdcd",textAlign:"center",border:"1px solid black ",borderTop:"hidden"}]}></Text>
         </View>  
