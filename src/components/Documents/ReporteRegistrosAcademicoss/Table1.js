    ...
    <View style={{ paddingBottom: "150px" }}>
      ...
      <View style={styles.table}>
        <View style={styles.tableHead}>
          <Text style={[styles.tableHeadCell, { flexBasis: "2.1%" }]}>NO.</Text>
          <Text style={[styles.tableHeadCell, { flexBasis: "50.2%" }]}>
            NOMBRE DEL PROGRAMA
          </Text>
          <Text style={[styles.tableHeadCell, { flexBasis: "10.2%" }]}>
            CENTRO O UNIDAD
          </Text>
        ...
        <View style={styles.tableHead3}>
          <Text style={[styles.tableHeadCell3,{ flexBasis: "6.3%" }]}> DVDR</Text>
          <Text style={[styles.tableHeadCell3,{ flexBasis: "15.3%" } ]}> POSGRADO</Text>
          <Text style={[styles.tableHeadCell3,{ flexBasis: "-4%" } ]}> DES</Text>
          <Text style={[styles.tableHeadCell3,{ flexBasis: "6.6%" } ]}> DEMS</Text>
          <Text style={[styles.tableHeadCell3,{ flexBasis: "7.4%" } ]}> DEFLE</Text>
        </View>
