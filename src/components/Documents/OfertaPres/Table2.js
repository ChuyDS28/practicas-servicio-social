        ...
        <View style={styles.tableBody}>
          ...
          />
            ...
            <Row
               No="2"
               Unidad="EMNH"
               Nombre="Taller de Cardiología Avanzada"
            ...
            <Row
               No="3"
               Unidad="ESIA ZAC"
               Nombre="Fundamentos de Valuación Inmobiliaria en Bienes Privados y Bienes
               Nacionales"
               Tipo="Básico (Presencial)"
               NoR="Curso"
               Hom="14"
            ...
            <Row
               No="5"
               Unidad="CECyT 2"
               Nombre="Medicina bioestática y modulación del envejecimiento"
               Tipo="Básico (Presencial)"
               NoR="Diplomado"
               Hom="14"
               Muj="14"
